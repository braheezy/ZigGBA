...
pub const DivResult = @import("math.zig").DivResult;
pub const div = @import("math.zig").div;
pub const divArm = @import("math.zig").divArm;
pub const sqrt = @import("math.zig").sqrt;
pub const arctan = @import("math.zig").arctan;
pub const arctan2 = @import("math.zig").arctan2;
pub const BgAffineSetOptions = @import("math.zig").BgAffineSetOptions;
pub const bgAffineSetDisplay = @import("math.zig").bgAffineSetDisplay;
pub const bgAffineSetDisplay2 = @import("math.zig").bgAffineSetDisplay2;
pub const bgAffineSetDisplay3 = @import("math.zig").bgAffineSetDisplay3;
pub const bgAffineSetOne = @import("math.zig").bgAffineSetOne;
pub const bgAffineSet = @import("math.zig").bgAffineSet;
pub const ObjAffineSetOptions = @import("math.zig").ObjAffineSetOptions;
pub const objAffineSetOam = @import("math.zig").objAffineSetOam;
pub const objAffineSetStruct = @import("math.zig").objAffineSetStruct;
pub const objAffineSet = @import("math.zig").objAffineSet;

// Imports relating to `CpuSet` and `CpuFastSet` BIOS calls.
pub const CpuSetOptions = @import("cpuset.zig").CpuSetOptions;
pub const CpuFastSetOptions = @import("cpuset.zig").CpuFastSetOptions;
pub const cpuSet = @import("cpuset.zig").cpuSet;
pub const cpuFastSet = @import("cpuset.zig").cpuFastSet;
pub const cpuSetCopy16 = @import("cpuset.zig").cpuSetCopy16;
pub const cpuSetCopy32 = @import("cpuset.zig").cpuSetCopy32;
pub const cpuSetFill16 = @import("cpuset.zig").cpuSetFill16;
pub const cpuSetFill32 = @import("cpuset.zig").cpuSetFill32;
pub const cpuFastSetCopy = @import("cpuset.zig").cpuFastSetCopy;
pub const cpuFastSetFill = @import("cpuset.zig").cpuFastSetFill;

// Imports for BIOS calls which decompress or decode data.
pub const UnCompHeader = @import("decompression.zig").UnCompHeader;
pub const BitUnPackOptions = @import("decompression.zig").BitUnPackOptions;
pub const bitUnPack = @import("decompression.zig").bitUnPack;
pub const lz77UnCompWRAM = @import("decompression.zig").lz77UnCompWRAM;
pub const lz77UnCompVRAM = @import("decompression.zig").lz77UnCompVRAM;
pub const huffUnComp = @import("decompression.zig").huffUnComp;
pub const rlUnCompWRAM = @import("decompression.zig").rlUnCompWRAM;
pub const rlUnCompVRAM = @import("decompression.zig").rlUnCompVRAM;
pub const diff8bitUnFilterWRAM = @import("decompression.zig").diff8bitUnFilterWRAM;
pub const diff8bitUnFilterVRAM = @import("decompression.zig").diff8bitUnFilterVRAM;
pub const diff16bitUnFilter = @import("decompression.zig").diff16bitUnFilter;

// Imports for sound-related BIOS calls.
pub const SoundDriverModeOptions = @import("sound.zig").SoundDriverModeOptions;
pub const WaveData = @import("sound.zig").WaveData;
pub const SoundArea = @import("sound.zig").SoundArea;
pub const soundBiasChange = @import("sound.zig").soundBiasChange;
pub const soundDriverInit = @import("sound.zig").soundDriverInit;
pub const soundDriverMode = @import("sound.zig").soundDriverMode;
pub const soundDriverMain = @import("sound.zig").soundDriverMain;
pub const soundDriverVSync = @import("sound.zig").soundDriverVSync;
pub const soundChannelClear = @import("sound.zig").soundChannelClear;
pub const midiKey2Freq = @import("sound.zig").midiKey2Freq;
pub const soundDriverVSyncOff = @import("sound.zig").soundDriverVSyncOff;
pub const soundDriverVSyncOn = @import("sound.zig").soundDriverVSyncOn;
