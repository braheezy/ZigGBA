...
pub const backgroundPaletteBank = @import("display_palette.zig").backgroundPaletteBank;
pub const objectPaletteBank = @import("display_palette.zig").objectPaletteBank;
...
pub const ObjectTileRange = @import("display_vram.zig").ObjectTileRange;
pub const ObjectTileFrameCache4Bpp = @import("display_vram.zig").ObjectTileFrameCache4Bpp;
pub const ObjectTileVariantFrameCache4Bpp = @import("display_vram.zig").ObjectTileVariantFrameCache4Bpp;
pub const object_tile_count_4bpp = @import("display_vram.zig").object_tile_count_4bpp;
pub const checkNoObjectTileOverlap = @import("display_vram.zig").checkNoObjectTileOverlap;
pub const frameTiles4Bpp = @import("display_vram.zig").frameTiles4Bpp;
