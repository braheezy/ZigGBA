...
const isGbaTarget = @import("../internal/util.zig").isGbaTarget;
...
pub const Affine2x2 = @import("affine.zig").Affine2x2;
pub const Affine3x2 = @import("affine.zig").Affine3x2;

// Fixed-point math types.
pub const isFixedPointType = @import("fixed.zig").isFixedPointType;
pub const isSignedFixedPointType = @import("fixed.zig").isSignedFixedPointType;
pub const isUnsignedFixedPointType = @import("fixed.zig").isUnsignedFixedPointType;
pub const FormatDecimalFixedOptions = @import("fixed.zig").FormatDecimalFixedOptions;
pub const sin_lut = @import("fixed.zig").sin_lut;
pub const FixedU16R16 = @import("fixed.zig").FixedU16R16;
pub const FixedI = @import("fixed.zig").FixedI;
pub const FixedI16R8 = @import("fixed.zig").FixedI16R8;
pub const FixedI16R14 = @import("fixed.zig").FixedI16R14;
pub const FixedI32R8 = @import("fixed.zig").FixedI32R8;
pub const FixedI32R16 = @import("fixed.zig").FixedI32R16;

// 2x2 matrix types.
pub const Mat2x2 = @import("mat2x2.zig").Mat2x2;
pub const Mat2x2I = @import("mat2x2.zig").Mat2x2I;
pub const Mat2x2FixedI16R8 = @import("mat2x2.zig").Mat2x2FixedI16R8;
pub const Mat2x2FixedI32R8 = @import("mat2x2.zig").Mat2x2FixedI32R8;
pub const Mat2x2FixedI32R16 = @import("mat2x2.zig").Mat2x2FixedI32R16;

// 3x3 matrix types.
pub const Mat3x3 = @import("mat3x3.zig").Mat3x3;
pub const Mat3x3I = @import("mat3x3.zig").Mat3x3I;
pub const Mat3x3FixedI16R8 = @import("mat3x3.zig").Mat3x3FixedI16R8;
pub const Mat3x3FixedI32R8 = @import("mat3x3.zig").Mat3x3FixedI32R8;
pub const Mat3x3FixedI32R16 = @import("mat3x3.zig").Mat3x3FixedI32R16;

// Rectangle types.
pub const Rect = @import("rect.zig").Rect;
pub const RectI8 = @import("rect.zig").RectI8;
pub const RectU8 = @import("rect.zig").RectU8;
pub const RectI16 = @import("rect.zig").RectI16;
pub const RectU16 = @import("rect.zig").RectU16;
pub const RectI32 = @import("rect.zig").RectI32;
pub const RectU32 = @import("rect.zig").RectU32;

// 2-vector types.
pub const Vec2 = @import("vec2.zig").Vec2;
pub const Vec2B = @import("vec2.zig").Vec2B;
pub const Vec2I = @import("vec2.zig").Vec2I;
pub const Vec2U = @import("vec2.zig").Vec2U;
pub const Vec2I8 = @import("vec2.zig").Vec2I8;
pub const Vec2I16 = @import("vec2.zig").Vec2I16;
pub const Vec2I32 = @import("vec2.zig").Vec2I32;
pub const Vec2U8 = @import("vec2.zig").Vec2U8;
pub const Vec2U16 = @import("vec2.zig").Vec2U16;
pub const Vec2U32 = @import("vec2.zig").Vec2U32;
pub const Vec2FixedI16R8 = @import("vec2.zig").Vec2FixedI16R8;
pub const Vec2FixedI32R8 = @import("vec2.zig").Vec2FixedI32R8;
pub const Vec2FixedI32R16 = @import("vec2.zig").Vec2FixedI32R16;

// 3-vector types
pub const Vec3 = @import("vec3.zig").Vec3;
pub const Vec3I = @import("vec3.zig").Vec3I;
pub const Vec3I8 = @import("vec3.zig").Vec3I8;
pub const Vec3I16 = @import("vec3.zig").Vec3I16;
pub const Vec3I32 = @import("vec3.zig").Vec3I32;
pub const Vec3FixedI16R8 = @import("vec3.zig").Vec3FixedI16R8;
pub const Vec3FixedI32R8 = @import("vec3.zig").Vec3FixedI32R8;
pub const Vec3FixedI32R16 = @import("vec3.zig").Vec3FixedI32R16;
